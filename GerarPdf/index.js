  ...
  const Submissao = async () => {
    ...
    const html = `<html>
      <body>
        ...
        font-size: 12pt;
        margin: 2pt;">Endereço: ${objetivosProfissionaisJSON.endereco}</p>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;">E-mail: <a href="mailto:${dadosPessoaisJSON.email}">${dadosPessoaisJSON.email}</a></p>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;">Telefone: ${dadosPessoaisJSON.telefone}</p>
        </div>
        ...
        <div>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;"><b>Data de nascimento: </b>${contatoJSON.dataNascimento}</p>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;"><b>Estado Civil: </b>${contatoJSON.estadoCivil}</p>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;"><b>Nacionalidade: </b>${contatoJSON.nacionalidade}</p>
            <p style="font-family: Arial, sans-serif;
        font-size: 12pt;
        margin: 2pt;"><b>Naturalidade: </b>${contatoJSON.naturalidade}</p>
            <br>
        </div>
